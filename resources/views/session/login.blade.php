    ...
    <div class="col-12 col-md-6 col-lg-4 mt-lg-5 ms-lg-5 pt-3 container-xxl bg-white rounded shadow-sm">
      ...
      <div class="row pb-5 mt-4 mx-auto border-top redondeo-superior-login shadow-sm-top">
        <div class="col-12 my-4">
          <div class="d-flex ">
            <h2 class="fw-bold">Iniciá sesión</h2>
        ...
        <div class="col-12">
          ...
          <div class="row">
            <div class="col-12 mb-3 d-flex justify-content-center">
              <p>¿Olvidaste tu contraseña? <a href="{{ route('password.request') }}" class="fw-bold text-reset text-decoration-none">Hace click acá</a></p>
            </div>
            <div class="col-12 mb-3 d-flex justify-content-center">
