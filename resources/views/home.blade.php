...
<div id="home"  class="pt-5">
  ...
  <div class="mt-4 bg-home">
    <div class="container">
      <div class="row p-t-b-200px">
        <div class="col-lg-6 bg-white p-100px rounded-5">
          <h2 class="fw-bolder titulo-h1">Conocé nivelo</h2>
          <p class="h5 lh-base pt-3">La App que revolucionará la accesibilidad para personas con movilidad reducida en nuestro país.</p>
...
<div class="my-4 py-5 container">
  <div class="row">
    ...
    <div class="col-6">
      <div class="ps-3 pt-5">
        <h2 class="fw-bolder titulo-h1">El desafío de la accesibilidad</h2>
...
<div>
  <div class="container py-5">
    <div class="row d-flex justify-content-center pb-5">
      <h2 class="text-center fw-bolder titulo-h1 mt-4 pb-5">Con nivelo podés</h2>
      ...
      <div class="col-4 d-flex flex-column justify-content-around ps-4">
        <div>
...
<div>
  <div class="container py-5">
    <div class="row d-flex justify-content-center">
      <div class="col-6">
        <h2 class="fw-bolder titulo-h1">Comunidad #YoNivelo</h2>
